...
test('logs the selected real date, reverses the existing log, and prevents future completion', async () => {
  ...
  expect(screen.getByRole('checkbox', { name: 'Log completion: Read a chapter' })).not.toBeChecked()
  await userEvent.click(screen.getByRole('checkbox', { name: 'Log completion: Read a chapter' }))
  ...
  expect(screen.getByRole('checkbox', { name: 'Undo completion: Read a chapter' })).toBeChecked()
  await userEvent.click(screen.getByRole('checkbox', { name: 'Undo completion: Read a chapter' }))
  ...
  expect(screen.getByRole('checkbox', { name: 'Log completion: Read a chapter' })).toBeDisabled()
})
